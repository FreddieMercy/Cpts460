...
*/
	if(filename)
	{
	    ...
	    p->usp = segSize-24; //the low end of the stack
		put_word(segNum, segNum, segSize-24);
		put_word(segNum, segNum, segSize-22);
		put_word(0, segNum, segSize-20);
		put_word(0, segNum, segSize-18);
		put_word(0, segNum, segSize-16);
		put_word(0, segNum, segSize-14);
		put_word(0, segNum, segSize-12);
		put_word(0, segNum, segSize-10);
		put_word(0, segNum, segSize-8);
		put_word(0, segNum, segSize-6);
		put_word(segNum, segNum, segSize-4);
		put_word(0x0200, segNum, segSize-2);
